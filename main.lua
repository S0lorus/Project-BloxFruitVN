...
local L_34_ = L_33_:Window("RelaxHub </>ng.thanhtai_06", Enum.KeyCode.LeftControl)
...
L_35_.Main:Label("Phương thức Farm")
local L_36_ = {
	"Cận Chiến",
	"Trái",
	"Súng",
...
_25msShared.SelectWeapon = "Cận Chiến"
L_35_.Main:Dropdown('Phương thức Farm', L_36_, "Cận Chiến", function(L_168_arg0)
	_25msShared.SelectWeapon = L_168_arg0
end)
task.spawn(function()
	while wait() do
		pcall(function()
			if _25msShared.SelectWeapon == "Cận Chiến" then
			...
			elseif _25msShared.SelectWeapon == "Kiếm" then
			...
			elseif _25msShared.SelectWeapon == "Súng" then
			...
			elseif _25msShared.SelectWeapon == "Trái" then
...
L_35_.Main:Label("Tự Động Farm")
L_35_.Main:Toggle("Tự động Farm Level", _25msShared.AutoFarmLevel, function(L_177_arg0)
...
L_35_.Main:Toggle("Tự động Farm Mob ở gần", _25msShared.NeareastFarm, function(L_181_arg0)
...
L_35_.Main:Label("Boss Katakuri & Xương")
L_35_.Main:Toggle("Tự động đánh Boss Katakuri", _25msShared.AutoDoughBoss, function(L_184_arg0)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
L_35_.Main:Toggle("Tự động Farm xương", _25msShared.AutoFarmBone, function(L_190_arg0)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
L_35_.Main:Toggle("Đổi xương", _25msShared.RandomBone, function(L_194_arg0)
...
L_35_.Main:Label("Farm Thông Thạo")
_25msShared.Kill_At = 33;
_25msShared.MasteryType = "Ải"
L_35_.Main:Slider("Khoảng cách dame", 1, 100, 33, function(L_195_arg0)
	_25msShared.Kill_At = L_195_arg0
end)
L_35_.Main:Dropdown("Chọn chế độ Farm", {
	"Ải",
	"Ở Gần"
}, "Ải", function(L_196_arg0)
	_25msShared.MasteryType = L_196_arg0
end)
L_35_.Main:Label("Hi")
L_35_.Main:Toggle("Tự động Farm thông thạo Trái", _25msShared.AutoFarmFruitMastery, function(L_197_arg0)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
spawn(function()
	while wait() do
		if _25msShared.AutoFarmFruitMastery and _25msShared.MasteryType == "Ải" then
			pcall(function()
				CheckQ()
							...
							if L_200_forvar1:FindFirstChild("HumanoidRootPart") and L_200_forvar1:FindFirstChild("Humanoid") and L_200_forvar1.Humanoid.Health > 0 then
								if L_200_forvar1.Name == NameMon then
									if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
										...
										until not _25msShared.AutoFarmFruitMastery or not _25msShared.MasteryType == "Ải" or L_200_forvar1.Humanoid.Health <= 0 or not L_200_forvar1.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false;
										UseSkill = false
									else
										UseSkill = false;
										StartMagnet = false;
		...
		elseif _25msShared.AutoFarmFruitMastery and _25msShared.MasteryType == "Ở Gần" then
			pcall(function()
				for L_202_forvar0, L_203_forvar1 in pairs(game.Workspace.Enemies:GetChildren()) do
					if L_203_forvar1.Name and L_203_forvar1:FindFirstChild("Humanoid") and L_203_forvar1:FindFirstChild("HumanoidRootPart") then
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_203_forvar1:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 2500 then
							...
							until not _25msShared.AutoFarmFruitMastery or not _25msShared.MasteryType == "Ở Gần" or not L_203_forvar1.Parent or L_203_forvar1.Humanoid.Health == 0;
							UseSkill = false;
							StartMagnet = false;
							_25msShared.AClick = false
						end
...
L_35_.Main:Toggle("Tự động Farm thông thạo Súng", _25msShared.AutoFarmGunMastery, function(L_204_arg0)
...
spawn(function()
	while wait() do
		if _25msShared.AutoFarmGunMastery and _25msShared.MasteryType == "Ải" then
			pcall(function()
				CheckQ()
						...
						pcall(function()
							for L_206_forvar0, L_207_forvar1 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
								if L_207_forvar1.Name == NameMon then
									...
									until L_207_forvar1.Humanoid.Health <= 0 or _25msShared.AutoFarmGunMastery == false or not _25msShared.MasteryType == "Ải" or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false;
									UseSkill = false;
									StartMagnet = false
								end
							end
		...
		elseif _25msShared.AutoFarmGunMastery and _25msShared.MasteryType == "Ở Gần" then
			pcall(function()
				for L_208_forvar0, L_209_forvar1 in pairs(game.Workspace.Enemies:GetChildren()) do
					if L_209_forvar1.Name and L_209_forvar1:FindFirstChild("Humanoid") and L_209_forvar1:FindFirstChild("HumanoidRootPart") then
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - L_209_forvar1:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 1500 then
							...
							until not _25msShared.AutoFarmGunMastery or not _25msShared.MasteryType == "Ải" or not L_209_forvar1.Parent or L_209_forvar1.Humanoid.Health == 0;
							UseSkill = false;
							StartMagnet = false
						end
					end
...
L_35_.Main:Label("Chọn skill sử dụng trong lúc Farm thông thạo Trái")
...
L_35_.Setting:Toggle("Chống người lạ Join Sever", false, function(L_221_arg0)
			...
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("RelaxHub found an Admin!")
						print("|RelaxHub DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
...
L_35_.Setting:Toggle("Chống bị phát hiện hack", true, function(L_224_arg0)
	task.spawn(function()
		local L_225_ = {
		...
		if setfflag then
			task.spawn(function()
				...
				print("|RelaxHub DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|RelaxHub DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
_25msShared.SkipDistance = 300;
L_35_.Setting:Slider("Khoảng cách bỏ qua", 1, 350, 300, function(L_231_arg0)
	_25msShared.SkipDistance = L_231_arg0
end)
L_35_.Setting:Toggle("Tự động thiết lập điểm home", _25msShared.Set, function(L_232_arg0)
...
L_35_.Setting:Toggle("Gom Mob", false, function(L_233_arg0)
...
L_35_.Setting:Toggle("Tự động bật Buso", true, function(L_236_arg0)
...
L_35_.Setting:Toggle("Quan sát tự động kích hoạt", false, function(L_237_arg0)
...
L_35_.Setting:Button("Tăng FPS", function()
	pcall(function()
...
L_35_.Setting:Toggle("Màn hình trắng", false, function(L_244_arg0)
...
L_35_.Setting:Toggle("Tự động kích hoạt Race V3", false, function(L_247_arg0)
...
L_35_.Setting:Toggle("Tự động kích hoạt Race V4", false, function(L_248_arg0)
...
L_35_.Setting:Toggle("Đánh nhanh (mượt)", true, function(L_249_arg0)
	_25msShared.FastAttack = L_249_arg0
end)
L_35_.Setting:Toggle("Bỏ qua TP", false, function(L_250_arg0)
	_25msShared.BypassTP = L_250_arg0
end)
L_35_.Setting:Toggle("Tự động nhấp màn hình (Farm)", false, function(L_251_arg0)
...
L_35_.Setting:Toggle("Ẩn sát thương", true, function(L_252_arg0)
...
L_35_.Setting:Toggle("Ẩn thông báo", false, function(L_253_arg0)
