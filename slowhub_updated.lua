...
b.Position = UDim2.new(0.10615778, 0, 0.16217947, 0)
b.Size = UDim2.new(0.0627121851, 0, 0.107579626, 0)
b.Image = "rbxassetid://110365071974573"

c.CornerRadius = UDim.new(0, 30)
c.Parent = b

d.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(244, 0, 0)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(146, 255, 251)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(180, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(96, 255, 231))}
d.Parent = b
...
elseif Lv == 2600 or SelectMonster == "Skull Slayer" or SelectArea == 'Tiki Outpost 2' then
    Ms = "Skull Slayer"
    NameQuest = "NewTikiQuest" -- Cập nhật tên nhiệm vụ mới nếu có
    QuestLv = 2
    NameMon = "Skull Slayer"
    CFrameQ = CFrame.new(-16500, 110, 1600) -- Cập nhật vị trí NPC nhận nhiệm vụ mới
    CFrameMon = CFrame.new(-16750, 130, 1750) -- Cập nhật vị trí quái vật mới
Ms = "Skull Slayer"
NameQuest = "TikiQuest3"
QuestLv = 2
NameMon = "Skull Slayer"
