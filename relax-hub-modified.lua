...
if GuideModule then
    ...
    if success and module and type(module.ChangeDisplayedNPC) == "function" then
        hookfunction(module.ChangeDisplayedNPC, function()
        end)
    end
end
local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
function MaterialMon()
    ...
    local function shouldRequestEntrance(targetPosition, distance * 2Threshold)
        local distance * 2 = (humanoidRootPart.Position - targetPosition).Magnitude
        if distance * 2 >= distance * 2Threshold then
...
function fastpos(Pos)
    ...
    if currentTime - lastTweenTime >= tweenCooldown then
        ...
        local tween = game:GetService("TweenService"):Create(
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / Speed, Enum.EasingStyle.Linear), {
            CFrame = Pos
        })
        tween:Play()
...
function TPB(pos, boat)
    ...
    if currentTime - lastTPBTime >= tpbCooldown then
        ...
        local distance * 2 = (boat.CFrame.Position - pos.Position).Magnitude
        local speed = getgenv().SpeedBoat
        local info = TweenInfo.new(distance * 2 / speed, Enum.EasingStyle.Linear)
        if distance * 2 <= 25 then
            ...
            local tween = tween_s:Create(boat, info, {
                CFrame = pos
            })
            tween:Play()
...
function topos(Tween_Pos)
    pcall(function()
        if game:GetService("Players").LocalPlayer and game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid") and game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game:GetService("Players").LocalPlayer.Character.Humanoid.Health > 0 and game:GetService("Players").LocalPlayer.Character.HumanoidRootPart then
            ...
            b1 = CFrame.new(
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X, DefualtY, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
            IngoreY = true
            if IngoreY and (b1.Position - targetCFrameWithDefualtY.Position).Magnitude > 5 then
                ...
                tween = aN:Create(
                    game:GetService("Players").LocalPlayer.Character["HumanoidRootPart"], aO, {
                ...
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X, TargetY, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
            else
                local tweenfunc = {}
                local aN = game:GetService("TweenService")
                local aO = TweenInfo.new((targetPos - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).Magnitude / TweenSpeed, Enum.EasingStyle.Linear)
...
local function GetEnemiesInRange(character, range * 2)
    ...
    for _, enemy in ipairs(enemies) do
        ...
        if rootPart and IsEntityAlive(enemy) then
            local distance * 2 = (rootPart.Position - playerPos).Magnitude
            if distance * 2 <= range * 2 then
...
Toggle = LGa:AddToggle("Toggle", {
    Title = "Tự động tham gia lại khi bị Ki",
    Default = false
})
Toggle:OnChanged(function(Value)
...
local Toggle = Settings:AddToggle("Toggle", {
    Title = "Tự động thiết lập điểm hồi sinh",
    Default = false
})
...
Toggle = Settings:AddToggle("Bypass TP", {
    Title = "Dừng Reset Teleport Khi Có Huyền Thoại",
    Default = false
})
Toggle:OnChanged(function(Value)
            ...
            for _, enemy in ipairs(enemies) do
                ...
                if getgenv().BringMonster and enemy:FindFirstChild("Humanoid") and enemy:FindFirstChild("HumanoidRootPart") then
                    ...
                    if humanoid and rootPart and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                        local distance * 2 = (rootPart.Position - LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
                        if getgenv().StartMagnet and (enemy.Name == MonFarm or enemy.Name == Mon) and humanoid.Health > 0 and distance * 2 <= 350 then
...
Toggle = Settings:AddToggle("Toggle", {
    Title = "Vị trí quay",
    Description = "Vị trí quay khi Farm",
    Default = true
})
Toggle:OnChanged(function(Value)
...
Toggle = Settings:AddToggle("Toggle", {
    Title = "Tự động giảm Lag Farm an toàn",
    Default = true
})
Toggle:OnChanged(function(Value)
...
Toggle = Settings:AddToggle("Toggle", {
    ...
    Description = "Tính năng này giúp bạn Farm an toàn mà không bị phát hiện",
    Default = true
})
Toggle:OnChanged(function(Value)
            ...
            if canRun then
                ...
                spawn(function()
                    ...
                    if not questVisible then
                        ...
                        CheckQuest()
                        if BypassTP then
                            local distance * 2 = (humanoidRoot.Position - CFrameQuest.Position).Magnitude
                            if distance * 2 > 1500 then
                                BTP(CFrameQuest * CFrame.new(0, 20, 5))
                            elseif distance * 2 < 1500 then
                                topos(CFrameQuest)
                            end
                        else
                            topos(CFrameQuest)
            ...
            pcall(function()
                ...
                if game.ReplicatedStorage:FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                        for _, v in pairs(game.Workspace.Enemies:GetChildren()) do
                            if getgenv().AutoFarm and v.Name == "Cake Prince" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then                                
                                repeat 
                                    game:GetService("RunService").Heartbeat:wait()
                                    AutoHaki()
                                    EquipWeapon(getgenv().SelectWeapon)
...
Toggle = Stack:AddToggle("Toggle", {
    Title = "Tự động nhận Melee",
    Default = false
})
Toggle:OnChanged(function(Value)
...
Toggle = Stack:AddToggle("Toggle", {
    Title = "Teleport tới Fruit [ Hop Server ]",
    Default = false
})
Toggle:OnChanged(function(Value)
            ...
            pcall(function()
                ...
                if player.Data.Level.Value >= 1500 and World2 then
                    ...
                    if replicatedStorage.Remotes["CommF_"]:InvokeServer("ZQuestProgress", "General") == 0 then
                        ...
                        elseif not workspaceEnemies:FindFirstChild("rip_indra") and (CFrame.new(- 26880.934, 22.849, 473.19).Position - player.Character.HumanoidRootPart.Position).Magnitude <= 1000 then
...
task.spawn(function()
    while task.wait(0.1) do
        ...
        pcall(function()
            ...
            local distance * 2ToBoss = (CFrame.new(- 5539.311, 313.801, - 2972.372).Position - humanoidRootPart.Position).Magnitude
            if distance * 2ToBoss <= 500 then
                ...
                UnEquipWeapon(getgenv().SelectWeapon)
                if BypassTP then
                    local distance * 2ToCFrameBoss = (humanoidRootPart.Position - CFrameBoss.Position).Magnitude
                    if distance * 2ToCFrameBoss > 1500 then
                        BTP(CFrameBoss)
                    elseif distance * 2ToCFrameBoss <= 1500 then
                        topos(CFrameBoss)
                    end
                end
...
Toggle = Stack:AddToggle("Toggle", {
    ...
    Description = "Tìm Server mới có Elite Hunter",
    Default = false
})
Toggle:OnChanged(function(Value)
        ...
        if getgenv().AutoEliteHunter and World3 then
            pcall(function()
                ...
                if questGui.Visible == true then
                    ...
                    local foundEnemy = false                    
                    for _, enemy in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if table.find(eliteNames, enemy.Name) and enemy:FindFirstChild("Humanoid") and enemy:FindFirstChild("HumanoidRootPart") and enemy.Humanoid.Health > 0 then                            
                            foundEnemy = true
                            repeat
                                task.wait(0.2)
                                AutoHaki()
        ...
        pcall(function()
            if getgenv().AutoTouchPadHaki and World3 then
                ...
                repeat
                    topos(target1)
                    task.wait(0.2)
                until getgenv().StopTween == true or getgenv().AutoTouchPadHaki == false or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - target1.Position).Magnitude <= 10
                task.wait(0.5)                
                ...
                repeat
                    topos(target2)
                    task.wait(0.2)
                until getgenv().StopTween == true or getgenv().AutoTouchPadHaki == false or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - target2.Position).Magnitude <= 10
                task.wait(0.5)                
                ...
                repeat
                    topos(target3)
                    task.wait(0.2)
                until getgenv().StopTween == true or getgenv().AutoTouchPadHaki == false or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - target3.Position).Magnitude <= 10
                task.wait(0.5)               
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        pcall(function()
            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if getgenv().AutoDoughKing and StartCakegetgenv().StartMagnet and (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and (v.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 300 then
                            ...
                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do  
                                if (v.Name == "Baking Staff" or v.Name == "Head Baker" or v.Name == "Cake Guard" or v.Name == "Cookie Crafter") and v.Humanoid.Health > 0 then
                                    repeat
                                        ...
                                        topos(v.HumanoidRootPart.CFrame * Pos)
                                    until getgenv().AutoDoughKing == false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        else
                                ...
                                for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            ...
                                            until getgenv().AutoDoughKing == false or v.Humanoid.Health <= 0 or not v.Parent or game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice")
                                        end
                                    end
                                end
                            end
    ...
    while task.wait(0.2) do
        if getgenv().DojoClaimQuest and World3 then
            pcall(function()
                ...
                local distance * 2 = (DojoQuestNpc.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
...
spawn(function()
    while task.wait(0.2) do
        if getgenv().DragonTalonUpgrade and World3 then
            ...
            local distance * 2 = (UzothNPC.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
            if distance * 2 > 5 then
                topos(UzothNPC)
            else
                local ohTable1 = {
...
Toggle = Other:AddToggle("Toggle", {
    Title = "Dừng khi có Chén Thánh or Key Râu Đen",
    Default = false
})
Toggle:OnChanged(function(Value)
...
Toggle = Blog:AddToggle("Toggle", {
    Title = "Buy Fruit đã chọn trong Shop",
    Default = false
})
Toggle:OnChanged(function(Value)
...
Toggle = Blog:AddToggle("Toggle", {
    Title = "Auto lấy Fruit thấp beli trong túi để Raid",
    Default = false
})
Toggle:OnChanged(function(Value)
        ...
        pcall(function()
            if getgenv().Auto_Dungeon then
                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
                    local specialMicrochip = game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip")
...
Toggle = Sea:AddToggle("Toggle", {
    Title = "Auto đi xuyên đá khi thuyền chạy",
    Default = true
})
Toggle:OnChanged(function(Value)
...
function CheckEnemiesBoat()
    ...
    return enemies:FindFirstChild("FishBoat") or enemies:FindFirstChild("PirateBrigade") or enemies:FindFirstChild("PirateGrandBrigade") and true or false
end
function CheckShark()
    local workspace = game:GetService("Workspace")
        ...
        pcall(function()
            ...
            for _, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v.Name == "FishBoat" and v:FindFirstChild("Engine") then
                    ...
                    until not v.Parent or v.Health.Value <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") or not v:FindFirstChild("Engine") or not getgenv().RelzFishBoat
                    Skillaimbot = false
                    getgenv().SeaSkill = false
                end
            end
                ...
                if workspace:FindFirstChild("SeaBeasts") then
                    for _, v in pairs(workspace.SeaBeasts:GetChildren()) do
                        if CheckSeaBeast() then
                            ...
                            until not getgenv().AutoSeaBest or not v:FindFirstChild("Humanoid") or not v:FindFirstChild("HumanoidRootPart") or v.Humanoid.Health < 0 or not v.Parent
                            Skillaimbot = false
                            getgenv().SeaSkill = false
                        end
                    end
            ...
            if getgenv().SeaSkill then
                ...
                if getgenv().UseSeaFruitSkill and not DoneSkillFruit then
                    ...
                    if getgenv().SkillFruitZ then
                        UseSkill("Z", getgenv().SeaHoldSKillZ)
                    end
                    if getgenv().SkillFruitX then
                        UseSkill("X", getgenv().SeaHoldSKillX)
                    end
                    if getgenv().SkillFruitC then
                        UseSkill("C", getgenv().SeaHoldSKillC)
                    end
                    if getgenv().SkillFruitV then
                        UseSkill("V", getgenv().SeaHoldSKillV)
                    end
                    if getgenv().SkillFruitF then
                        UseSkill("F", getgenv().SeaHoldSKillF)
                    end                    
                    DoneSkillFruit = true
                end                
...
Toggle = Sea:AddToggle("Toggle", {
    Title = "Teleport tới đảo Kitsune",
    Default = false
})
Toggle:OnChanged(function(value)
...
Toggle = Sea:AddToggle("Toggle", {
    Title = "Auto Thu thập Azure Wisp",
    Default = false
})
Toggle:OnChanged(function(value)
...
Toggle = Sea:AddToggle("Toggle", {
    Title = "Teleport tới Frozen Dimension",
    Default = false
})
Toggle:OnChanged(function(Value)
...
task.spawn(function()
    while task.wait(0.5) do
        pcall(function()
            if UseSkill then
                for _, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if v.Name == MonFarm and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health <= v.Humanoid.MaxHealth * getgenv().Kill_At / 100 then                        
                        if getgenv().SkillZ then
                            useSkill("Z", getgenv().HoldSKillZ)
                        end
                        if getgenv().SkillX then
                            useSkill("X", getgenv().HoldSKillX)
                        end
                        if getgenv().SkillC then
                            useSkill("C", getgenv().HoldSKillC)
                        end
                    end
                end
            end
...
Toggle = Volcanic:AddToggle("MyToggle", {
    Title = "Teleport tới Prehistoric Island",
    Default = false
})
Toggle:OnChanged(function(Value)
        ...
        if getgenv().AutoDefendVolcano then
            ...
            if rock then
                ...
                if rock.Color == Color3.fromRGB(185, 53, 56) or rock.Color == Color3.fromRGB(185, 53, 57) then
                    ...
                    if rootPart then
                        local distance * 2 = (rootPart.Position - rock.Position).Magnitude
                        if distance * 2 <= 1 then
                            if getgenv().UseMelee then
                                equipAndUseWeapon("Melee")
                            end
                            if getgenv().UseSword then
                                equipAndUseWeapon("Sword")
                            end
                            if getgenv().UseGun then
                                equipAndUseWeapon("Gun")
                            end
                        end
                    end
            ...
            for _, bone in ipairs(bones) do
                if typeof(topos) == "function" then
                    ...
                    repeat
                        ...
                        local distance * 2 = (playerPos - bonePos).Magnitude
                    until distance * 2 <= 1
                end
            end
        end
            ...
            if # eggs > 0 then
                ...
                if targetEgg:IsA("Model") and targetEgg.PrimaryPart and typeof(topos) == "function" then
                    ...
                    repeat
                        ...
                        local distance * 2 = (playerPos - eggPos).Magnitude
                    until distance * 2 <= 1                    
                    game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                    wait(1)
                    game:GetService("VirtualInputManager"):SendKeyEvent(false, "E", false, game)
...
local RunService = game:GetService("RunService")
Toggle = Race:AddToggle("Toggle", {
    Title = "Teleport tới Draco Trial Door",
    Default = false
})
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", {
    Title = "Teleport tới Ancient Clock",
    Default = false
})
Toggle:OnChanged(function(Value)
...
local Toggle = Race:AddToggle("Toggle", {
    ...
    while task.wait(0.5) do 
        pcall(function()
            if getgenv().QuestTrain_2 and World3 and game.Players.LocalPlayer.Character then
                ...
                if BypassTP then
                    local playerPos = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
                    local distance * 2 = (playerPos - BonePos.Position).Magnitude
                    if distance * 2 > 1500 then
                        BTP(BonePos)
                    else
                        topos(BonePos)
...
Toggle = Race:AddToggle("Toggle", {
    Title = "Teleport tới điểm cao Nhắt",
    Default = false
})
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", {
    Title = "Teleport tới Advanced Fruit Dealer",
    Default = false
})
Toggle:OnChanged(function(Value)
...
Toggle = Race:AddToggle("Toggle", {
    Title = "Nhìn trăng và Bật tộc V3",
    Default = false
})
Toggle:OnChanged(function(Value)
...
spawn(function()
    while task.wait(0.1) do
        if not getgenv().TeleportToGear or not World3 then
            continue
        end
        local MysticIsland = game:GetService("Workspace").Map:FindFirstChild("MysticIsland")
    ...
    for _, v in ipairs(locations) do
        if v.Name ~= "Sea" then
            if IslandESP then
                ...
                if textLabel then
                    local distance * 2 = (headPosition - v.Position).Magnitude / 3
                    textLabel.Text = string.format("%s\n%d Distance", v.Name, math.floor(distance * 2 + 0.5))
                end
            else
        ...
        pcall(function()
            if v:IsA("Model") and string.find(v.Name, "Fruit") and v:FindFirstChild("Handle") then
                ...
                if DevilFruitESP then
                    ...
                    local textLabel = bill:FindFirstChildOfClass("TextLabel")
                    if textLabel then
                        local distance * 2 = (headPosition - handle.Position).Magnitude / 3
                        textLabel.Text = string.format("%s\n%d Distance", v.Name, math.floor(distance * 2 + 0.5))
                    end
                else
        ...
        pcall(function()
            if v ~= player and v.Character and v.Character:FindFirstChild("Head") and v.Character:FindFirstChild("Humanoid") then
                ...
                if ESPPlayer then
                    ...
                    local textLabel = bill:FindFirstChildOfClass("TextLabel")
                    if textLabel then
                        local distance * 2 = math.floor((headPosition - head.Position).Magnitude / 3 + 0.5)
                        local healthPercent = math.floor((humanoid.Health / humanoid.MaxHealth) * 100 + 0.5)
                        textLabel.Text = string.format("%s\n%d Distance\nHealth: %d%%", v.Name, distance * 2, healthPercent)
